...
def v_learning(board: Board):
    ...
    current_v_score = Board.v_table[board.last_move_fen]
    ...
    Board.v_table[board.last_move_fen] += ALPHA * (board.last_reward + (GAMMA * max_reward_position_v_score_for_next_state) - current_v_score)
